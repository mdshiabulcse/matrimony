...
<link href="{{ asset('assets_frontend/css/bootstrap-3.1.1.min.css') }}" rel='stylesheet' type='text/css' />
...
<!----font-Awesome----->
<link href="{{ asset('assets_frontend/css/font-awesome.css')}}" rel="stylesheet">
<!----font-Awesome----->
<script>
...
<body>
<script src="{{ asset('assets_frontend/../../../../m.servedby-buysellads.com/monetization.js')}}" type="text/javascript"></script>
<script>
(function(){
...
<div class="bs-example bs-example-tabs right-sidebar-tab-notification" data-example-id="togglable-tabs">
    ...
    <div id="w3lDemoBar" class="w3l-demo-bar">
        <div class="demo-btns">
        <a href="https://w3layouts.com/?p=45170">
        ...
        <a href="https://w3layouts.com/checkout/?add-to-cart=45170" class="no-margin-bottom-mobile">
...
<div class="map">
 ...
 <div class="footer">
     <div class="container">
         ...
         <div class="clearfix"> </div>
         <div class="copy">
           <p>Copyright © 2021 Wetrustcoders . All Rights Reserved  | Developed by <a href="#" target="_blank">WETRUSTCODERS</a> </p>
         </div>
     </div>
 </div>
</body>
